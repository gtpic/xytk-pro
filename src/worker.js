      ...
      try {
        const stmts = [
          ...
          env.db.prepare(`INSERT OR IGNORE INTO settings (key, value) VALUES 
            ...
            ('site_footer_1', '<p>Copyright @ 2026 <a href="/" target="_blank">夏雨图库 </a> - 基于 Cloudflare构建免费个人图床网站</p>'),
            ('site_footer_2', '<a href="tencent://message/?uin=137222445" target="_blank"><i class="fab fa-qq"></i> 137222445</a><span class="split" style="margin: 0 3px;">|</span><a href="https://t.me/gv1688" target="_blank"><i class="fab fa-telegram-plane"></i> @gv1688</a><span class="split" style="margin: 0 3px;">|</span><a href="/admin" target="_blank">登陆</a>')`),
